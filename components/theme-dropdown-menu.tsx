...
import { ChevronDown, ChevronRight, Home, Users, Settings, FileText, Calendar, BarChart3, Zap, Shield, Database, Globe } from 'lucide-react';
...
const NavigationMenu = () => {
  ...
  const handleNestedDropdownClick = (itemId, e) => {
    e.stopPropagation();
                      ...
                      <div key={subItem.id || subItem.label}>
                        {subItem.items ? (
                          ...
                          <div className="relative">
                            <button
                              onClick={(e) => handleNestedDropdownClick(subItem.id, e)}
                            ...
                            >
                              ...
                              <ChevronRight 
                                className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${
                                  openNestedDropdown === subItem.id ? 'rotate-90' : ''
                                }`} 
                              />
                            </button>

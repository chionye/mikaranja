...
;
const Header = ()=>{
    const { logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const userInitials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
const TaskProvider = ({ children })=>{
    ...
    const deleteTask = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (id)=>{
        console.log(`TaskContext: Optimistically deleting task ID: ${id} from local state and localStorage.`);
        setTodos((prevTodos)=>{
        ...
        if (!isPotentiallyApiTask) {
            console.log(`TaskContext: Task ID: ${id} is a local-only task. Skipping API delete.`);
            return;
        }
        try {
            console.log(`TaskContext: Attempting to delete task ID: ${id} from API.`);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Requests"].deleteTodo(__TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2f$api$2d$routes$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].UpdateTodo(id));
            if (response.status === 200) {
                console.log(`TaskContext: Task ID: ${id} successfully deleted from API.`);
            } else {
                console.error(`TaskContext: API delete failed for task ID: ${id}. Status: ${response.status}`, response.data);
            }
        } catch (error) {
            console.error(`TaskContext: Error during API delete request for task ID: ${id}.`, error);
        }
    }, []);
    const contextValue = {
        todos,
...
//# sourceMappingURL=_837a6d55._.js.map
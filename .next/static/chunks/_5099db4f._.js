...
function TasksPage() {
    ...
    const { todos, setTodos } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$TaskContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTaskContext"])();
        ...
        "TasksPage.useCallback[fetchTodos]": async ()=>{
            ...
            try {
                ...
                if (response.status === 200 && response.data && Array.isArray(response.data.todos)) {
                    const fetchedDummyTodos = response.data.todos;
                    setTodos(fetchedDummyTodos);
    ...
    const filteredTodos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TasksPage.useMemo[filteredTodos]": ()=>{
            ...
            return todos.filter({
                "TasksPage.useMemo[filteredTodos]": (todo)=>todo.todo.toLowerCase().includes(lowerCaseSearchTerm)
            }["TasksPage.useMemo[filteredTodos]"]);
        }
    }["TasksPage.useMemo[filteredTodos]"], [
        todos,
...
_s(TasksPage, "zEO5cy0Wfpef6rPf7rgB8Ois/o0=", false, function() {
    return [
...
//# sourceMappingURL=_5099db4f._.js.map